...
All formal and authoritative work is published on Zenodo and identified by DOI.

This GitHub repository is an index and navigation layer only.  
It does not constitute the source of record and must not be used as an authoritative reference for formal claims.

The authoritative source of truth is the Zenodo DOI corpus.

In case of any discrepancy between this repository and Zenodo records,  
the Zenodo DOI version prevails.
...
All citations of AGDAU work MUST reference the corresponding Zenodo DOI records.

GitHub links are non-canonical and provided for navigation only.

---

## Zenodo DOI Corpus

All AGDAU publications are listed below as canonical DOI records.

Each entry includes:
Title — Zenodo record — DOI (authoritative)
...
License: Pending. Contact author for licensing and usage terms.
